...
export const WeddingInvitationPage = () => {
  ...
  const setFirstName = useWeddingBounceStore((state) => state.setFirstName);
  ...
  const eventDate = useWeddingBounceStore((state) => state.eventDate);
  ...
  const setEventDate = useWeddingBounceStore((state) => state.setEvenDate);
  const setEventTime = useWeddingBounceStore((state) => state.setEventTime);

  const isConfirmed = useWeddingBounceStore((state) => state.isConfirm);
  const setIsConfirmed = useWeddingBounceStore((state) => state.setIsConfirm);
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                value={guestCount}
                // el + transforma el value que espera un string a number
